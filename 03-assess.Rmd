...
```{r raw-data-information, echo = FALSE, eval=FALSE}
...
```{r analysis-data-information, echo = FALSE, eval=FALSE}
...
```{r code-files-information, echo = FALSE, eval=FALSE}
...
```{r adding-rows, echo = FALSE, eval=FALSE}
