...
\usepackage{hyperref}
\hypersetup{
            pdftitle={Accelerating Computational Reproducibility in Economics},
            pdfauthor={ACRE Team},
            pdfborder={0 0 0},
            breaklinks=true}
...
\title{Accelerating Computational Reproducibility in Economics}
...
\includegraphics[width=0.6\linewidth]{BITSS_logo_horizontal}
...
\NormalTok{temp_eval <-}\StringTok{ }\OtherTok{FALSE}
\end{Highlighting}
\end{Shaded}
