...
\toprule
\multicolumn{1}{c}{ } & \multicolumn{2}{c}{\makecell[c]{2 weeks\\(\textasciitilde{}10 days)}} & \multicolumn{2}{c}{\makecell[c]{1 month\\(\textasciitilde{}20 days)}} & \multicolumn{2}{c}{\makecell[c]{1 semester\\(\textasciitilde{}100 days)}} \\
\cmidrule(l{3pt}r{3pt}){2-3} \cmidrule(l{3pt}r{3pt}){4-5} \cmidrule(l{3pt}r{3pt}){6-7}
\multicolumn{1}{c}{\makecell[c]{Stages of\\ Reproduction}} & \multicolumn{1}{c}{\makecell[c]{analysis\\data}} & \multicolumn{1}{c}{\makecell[c]{raw\\data}} & \multicolumn{1}{c}{\makecell[c]{analysis\\data}} & \multicolumn{1}{c}{\makecell[c]{raw\\data}} & \multicolumn{1}{c}{\makecell[c]{analysis\\data}} & \multicolumn{1}{c}{\makecell[c]{raw\\data}} \\
...
\multicolumn{1}{c}{Scoping} & \multicolumn{2}{c}{10\% (1 day)} & \multicolumn{2}{c}{10\% (2 day)} & \multicolumn{2}{c}{10\% (10 days)} \\
\cmidrule(l{3pt}r{3pt}){1-1} \cmidrule(l{3pt}r{3pt}){2-3} \cmidrule(l{3pt}r{3pt}){4-5} \cmidrule(l{3pt}r{3pt}){6-7}
\multicolumn{1}{c}{Assesment} & \multicolumn{2}{c}{35\%} & \multicolumn{2}{c}{25\%} & \multicolumn{2}{c}{15\%} \\
\cmidrule(l{3pt}r{3pt}){1-1} \cmidrule(l{3pt}r{3pt}){2-3} \cmidrule(l{3pt}r{3pt}){4-5} \cmidrule(l{3pt}r{3pt}){6-7}
\multicolumn{1}{c}{Improvement} & \multicolumn{1}{c}{25\%} & \multicolumn{1}{c}{0\%} & \multicolumn{2}{c}{40\%} & \multicolumn{1}{c}{20\%} & \multicolumn{1}{c}{30\%} \\
...
\multicolumn{1}{c}{Robustness} & \multicolumn{1}{c}{25\%} & \multicolumn{1}{c}{5\%} & \multicolumn{2}{c}{25\%} & \multicolumn{2}{c}{25\%} \\
...
\item
  ...
  \tightlist
  \item
    \href{https://scholar.google.com/scholar?oi=bibs\&cluster=14593109523353163362\&btnI=1\&hl=en}{The Effects of Exposure to Better Neighborhoods on Children: New Evidence from the Moving to Opportunity Experiment}\\
  \item
    \href{https://scholar.google.com/scholar?oi=bibs\&cluster=9632592800621257435\&btnI=1\&hl=en}{Railroads of the Raj: Estimating the Impact of Transportation Infrastructure}
  \item
    \href{https://scholar.google.com/scholar?oi=bibs\&cluster=14882938779698367846\&btnI=1\&hl=en}{The Race between Man and Machine: Implications of Technology for Growth, Factor Shares, and Employment}
  \item
    \href{https://scholar.google.com/scholar?oi=bibs\&cluster=12934661864410944134\&btnI=1\&hl=en}{The Surprisingly Swift Decline of US Manufacturing Employment}
  \item
    \href{https://scholar.google.com/scholar?oi=bibs\&cluster=4926806483525389434\&btnI=1\&hl=en}{Monetary Policy According to HANK}
  \item
    \href{https://scholar.google.com/scholar?oi=bibs\&cluster=2965198650429157010\&btnI=1\&hl=en}{The Determinants and Welfare Implications of US Workers' Diverging Location Choices by Skill: 1980-2000}
  \item
    \href{https://scholar.google.com/scholar?oi=bibs\&cluster=8446349612486899408\&btnI=1\&hl=en}{Disruptive Change in the Taxi Business: The Case of Uber}
  \item
    \href{https://scholar.google.com/scholar?oi=bibs\&cluster=6025324097129642737\&btnI=1\&hl=en}{Bartik Instruments: What, When, Why, and How}
  \item
    \href{https://scholar.google.com/scholar?oi=bibs\&cluster=16547462466761479574\&btnI=1\&hl=en}{Importing Political Polarization? The Electoral Consequences of Rising Trade Exposure}
  \item
    \href{https://scholar.google.com/scholar?oi=bibs\&cluster=4766165857030680369\&btnI=1\&hl=en}{Long-Run Impacts of Childhood Access to the Safety Net}
  \end{itemize}
\item
...
\item
  If there is, search \href{https://www.socialsciencereproduction.org/}{socialsciencereproduction.org} to verify that there is a recorded reproduction.\\
\item
...
\hline
"Provincial Administration Reports" & A4 & coast\_simplepoint2.csv; rivers\_simplepoint2.csv; ... & Data/maps/ & TRUE & FALSE\\
\hline
...
\begin{longtable}[]{@{}
  ...
  >{\centering\arraybackslash}p{(\columnwidth - 4\tabcolsep) * \real{0.1746}}
  >{\centering\arraybackslash}p{(\columnwidth - 4\tabcolsep) * \real{0.2063}}@{}}
\toprule()
...
\leavevmode\vadjust pre{\hypertarget{ref-chang2015economics}{}}%
...
\leavevmode\vadjust pre{\hypertarget{ref-simonsohn2019specification}{}}%
