...
**For reproducers:**  
   ...
   1. Contacting the original author(s) to request items that are missing;  
   2. Asking for additional guidance when some materials have been shared;  
   3. Response to an original author who has refused to share an item due to undisclosed reasons;  
   4. Response to an original author who has refused to share data due to legal or ethical constraints;  
   5. Contacting the original author(s) to share the results of your reproduction;  
   6. Responding to adversarial responses from original authors.  
