...
knitr::include_graphics("images/paper-claims.png") 
...
# BUG: cannot build book to PDF if svg is in images folder
knitr::include_graphics("images/stages.svg") 
``` 
...
knitr::include_graphics("images/unit-of-analysis.png") 
```
