...
\usepackage{hyperref}
\hypersetup{
            pdftitle={Advancing Computational Reproducibility in Economics},
            pdfauthor={ACRE Team},
            pdfborder={0 0 0},
            breaklinks=true}
...
\title{Advancing Computational Reproducibility in Economics}
...
\addcontentsline{toc}{section}{Identify your relevant timeline.}
