...
1. Search in the mapping database (populated  in the mapping section above) and record the identifier(s) corresponding to the analytical choice to test (`entry_id`). If there is no entry corresponding for the specific lines, please create one. 
