...
\hypertarget{adding-information-on-how-to-access-confidentialpropietary-data}{%
\subsection{Adding information on how to access confidential/propietary data}\label{adding-information-on-how-to-access-confidentialpropietary-data}}

If the original authors cannot provide the raw or analytical data due to legal or ethical reasons, they can still provide information on how to access such data. The \href{https://www.aeaweb.org/journals/data/data-code-policy\#statement}{American Economic Association} requires original authors to provide Data Availability Statements (DAS) for such data sources. Use \href{sample-DAS.md}{this form} (\href{sample-DAS.pdf}{.pdf}, \href{sample-DAS.html}{.html} ) to assess the existence and completeness of any DAS.

\hypertarget{paper-level}{%
\section{Paper-level improvements}\label{paper-level}}

There are at least seven additional improvements you can make to improve a paper's overall reproducibility. These additional improvements can be applied across all reproducibility levels (including level 10). Record these improvements in the ``Paper-level improvements'' section.
...
5 - If the code was written using a proprietary statistical software (e.g., Stata or Matlab), re-write some parts of it using an open source statistical software (e.g., R, Python, or Julia).\\
...
Reproducers are welcome to suggest new paper-level improvements by editing this guide directly (edit button above) or submitting feedback to \href{mailto:acre+feedback@berkeley.edu}{\nolinkurl{acre+feedback@berkeley.edu}}.
