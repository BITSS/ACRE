...
\hypertarget{check-records-on-the-acre-platform-check-acre.}{%
\subsection{Check records on the ACRE platform \{\#check-acre\}.}\label{check-records-on-the-acre-platform-check-acre.}}
...
\hypertarget{describe-the-inputs.}{%
\section{Describe the inputs.}\label{describe-the-inputs.}}
