...
\tightlist
\item
  \protect\hyperlink{select}{\textbf{Paper selection}}, where you (the reproducer) will select a candiate paper and verify the availability of a reproduction package. Depending on availability, you will declare the paper and start the excercise, or select a new candidate paper (after leaving a short record);\\
\item
  \protect\hyperlink{scoping}{\textbf{Scoping}}, where you will define the scope of the exercise recording which claims, display items, and specifications you will focus for the remainder of the exercise;\\
\item
...
\item
  \protect\hyperlink{robust}{\textbf{Robustness checks}}, where you will identify feasible robustness checks and/or assess the reasonableness of specific variations in analytical choices.
\end{enumerate}
