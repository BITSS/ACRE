...
raw_data_info <- data.frame(`Data Source` = c('"Current Population Survey 2018"', 
                                              '"Provincial Administration Reports"', 
                                              '"2017 SAT scores"', "..."),
                            Page = c("A1", "A4", "4", "..."),
                            `Data Files` = c("cepr_march_2018.dta", 
                                             "coast_simplepoint2.csv; rivers_simplepoint2.csv; ...", 
                                             "Not available", "..."),
                            Location = c("data/", " Data/maps/", "data/to_clean/", "..."),
...
analysis_data_info <-
  data.frame(
    `Analytic Data` = c("final_data.csv", "all_waves.csv", "..."),
...
code_files_info <- data.frame(file_name = c("output_ table1.do", "data_ cleaning02.R", "..."),
                              location = c("code/analysis/", "code/cleaning", "..."),
                              inputs = c("analysis_ data01.csv", "admin_ 01raw.csv", "..."),
                              outputs = c("output1_ part1.txt", "analysis_ data02.csv","..."),
...
adding_rows_to_code <- data.frame(file_name = c("...", "MISSSING_
                                                CODE_FILE_1"),
                                  location = c("...", "unknown"),
...
Below table was originally used to produce above table in png.
...
```{r levels-of-computational-reproducibility-adjusted, echo = FALSE, eval=FALSE}
lcr_levels_adjusted <-
                          data.frame(
                            levels = c(
                              "L1: No materials",
