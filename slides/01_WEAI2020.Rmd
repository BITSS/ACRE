...
date:  "`r format(Sys.time(), '%d %B %Y')` | [slides](https://github.com/BITSS/ACRE_analysis/tree/master/04_documentation)"
output: 
...
# Platform: Home page  
---
background-image: url(Results.svg)
background-size: contain 
...
- RStudio (no, we will not be using R)
- Github Desktop

Also, please create and account in github.com
...
---
background-image: url("Images/version_control_diagram.png")
background-size: contain 
