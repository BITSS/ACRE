...
In this case, you can still combine this partial information with your knowledge from the paper and produce a "candidate" tree diagram. This may look like the following: 
