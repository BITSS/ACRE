...
Verify that the paper has a reproduction package. If there is no reproduction package, use our records to check if requests to authors a reproduction package have been made before. If nobody has yet submitted a similar request, you are encouraged to contact the authors using language suggested \protect\hyperlink{for-reproducers-contacting-the-authors-of-the-original-study}{here}, making sure to copy (\href{mailto:acre@berkeley.edu}{\nolinkurl{acre@berkeley.edu}}).
...
If the authors provide any materials, create a public project in the {[}Open Science Framework/ICPSRopen/Dataverse{]} and deposit all these materials under the name \texttt{Original\ reproduction\ materials\ for\ -\ Title\ of\ the\ paper}. Provide the URL for the repository in the ACRE records.

If the authors have been contacted before and provided no response, you are encouraged to follow up with a reminder email using the same language. Do not forget to copy (\href{mailto:acre@berkeley.edu}{\nolinkurl{acre@berkeley.edu}}).
...
\hypertarget{declare-specific-estimates-to-reproduce.}{%
\subsection*{Declare specific estimates to reproduce.}\label{declare-specific-estimates-to-reproduce.}}
\addcontentsline{toc}{subsection}{Declare specific estimates to reproduce.}
...
\hypertarget{declare-possible-robustness-checks-optional.}{%
\subsection*{Declare possible robustness checks (optional).}\label{declare-possible-robustness-checks-optional.}}
\addcontentsline{toc}{subsection}{Declare possible robustness checks (optional).}
