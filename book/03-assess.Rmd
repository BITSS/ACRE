...
## Describe inputs  
List all the input materials found or referred in the reproduction package
...
List all raw data sources as described in the paper (for example "CPS March 2018 from CEPR") and, if raw data is available, match it with the filename in the reproducibility package (`cepr_march_2018.dta`). The result will have the following structure:    
...
- Provide brief description  
 ...
 List and describe all the analytic data sets. The resulting report will have the following structure:  
...
### Descript code scripts  
List and describe all the code scripts. The result will have the following structure.    
...
Draw diagrams from output to raw data sources. For more examples of diagrams connecting final output to initial raw data, [see here](06_sample_diagrams.md).    
