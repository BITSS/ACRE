...
- AEA updates [policy in 2019](https://www.aeaweb.org/journals/policies/data-code/). 
    ...
    - See Lars Vilhuber after this presentation (same zoom channel) for more information 
--
...
Reproductions can easily gravitate towards adversarial exchanges.
  - Original authors have a more senior position and can use it to deter in-depth reproductions from early career researchers (ECR) 
  - ECR have also incentives to emphasize unsuccessful reproductions 
  - The media also focuses on eye-catching headlines
...
### Data sources  
Connect the data sources in the papers text with specific raw data files. 
--
...
You can check the [ACRE guidelines](https://bitss.github.io/ACRE/), and also contribute if you want.
...
- [RStudio](https://rstudio.com/products/rstudio/download/#download) (no, we will not be using R)
- [Github Desktop App](https://desktop.github.com/)

Also, please create and account in [github.com](https://github.com/), be confirm that account in your email. 
]
---
class: inverse, center, middle
name: part2
