...
Having collected all the information referenced above, you can now trace your output to reproduce its primary sources. Email the standardized spreadsheets from above (sections \@ref(desc-sourc), \@ref(desc-analy) and \@ref(desc-scripts)) to acre@berkeley.edu. Within 24hrs you will receive an email with a "reproduction tree" that represents the workflow behind each output.
