...
\toprule
\protect\hyperlink{scoping}{Scoping} & \protect\hyperlink{assessment}{Assessment} & \protect\hyperlink{improvements}{Improvement} & Robustness & Extension\tabularnewline
\midrule
\endhead
☐ Select paper & \protect\hyperlink{describe-inputs}{☐ Describe inputs} & Output-level imp: & &\tabularnewline
\protect\hyperlink{check-acre}{☐ Check ACRE} & \protect\hyperlink{diagram}{☐ Reproduction diagrams} & \protect\hyperlink{rd}{☐ + Raw data} & &\tabularnewline
\protect\hyperlink{verify-rep-mat}{☐ Search for rep. mat.} & \protect\hyperlink{score}{☐ Reproduction score} & & &\tabularnewline
\protect\hyperlink{read-summ}{☐ Read and summ.} & & & &\tabularnewline
Declare scope: & & & &\tabularnewline
\protect\hyperlink{outputs}{☐ Output(s)} & & & &\tabularnewline
\protect\hyperlink{intensive}{☐ Depth} & & & &\tabularnewline
\bottomrule
\end{longtable}
