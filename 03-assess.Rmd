...
raw_data_info <- data.frame(data_source = c('"Current Population Survey 2018"', '"Provincial Administration Reports"', '"2017 SAT scores"', "..."),
                            page = c("A1", "4", "4", "..."),
                            data_files = c("cepr_march_2018.dta", "coast_simplepoint2.csv; rivers_simplepoint2.csv; RAIL dummies.dta;railways_Dissolve_Simplify_point2.csv", "Not available", "..."),
                            known_missing = c(" ", "  ", " ", "..."),
