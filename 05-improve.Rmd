...
### Adding information on how to access confidential/propietary data

If the original authors cannot provide the raw or analytical data due to legal or ethical reasons, they can still provide information on how to access such data. The [American Economic Association](https://www.aeaweb.org/journals/data/data-code-policy#statement) requires original authors to provide Data Availability Statements (DAS) for such data sources. Use [this form](sample-DAS.md) ([.pdf](sample-DAS.pdf), [.html](sample-DAS.html) ) to assess the existence and completeness of any DAS.  
...
Reproducers are welcome to suggest new paper-level improvements by editing this guide directly (edit button above) or submitting feedback to <acre+feedback@berkeley.edu>.
