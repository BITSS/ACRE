...
## Contributing feedback on this Guide {#contrib-guide}
...
To report issues or provide feedback on the Social Science Reproduction Platform, please submit to the [Help category](https://forum.socialsciencereproduction.org/c/help/8) in the SSPP Forum or contact [ACRE@berkeley.edu](mailto:ACRE@berkeley.edu).

Major contributions to this Guide will be acknowledged below according to the Contributor Roles Taxonomy ([CRediT](https://casrai.org/credit/)). Major contributions are defined as any pushed revisions to the Guide language or source code beyond corrections of spelling and grammar.
