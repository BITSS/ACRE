...
If the original authors are unable to share the raw or analytical data due to legal or ethical reasons, the reproduction package can still be improved by including information on how to access such data. The American Economic Association \href{https://www.aeaweb.org/journals/data/data-code-policy\#statement}{requires} original authors to provide data availability statements (DAS) for such data sources. Use \href{sample-DAS.html}{this form} (\href{sample-DAS.pdf}{.pdf}, \href{https://github.com/BITSS/ACRE/blob/master/sample-DAS.md}{.md} ) to assess the completeness of any DAS.
...
\hypertarget{guidance-for-constructive-communication-between-reproducers-and-original-authors}{%
\chapter{Guidance for Constructive Communication Between Reproducers and Original Authors}\label{guidance-for-constructive-communication-between-reproducers-and-original-authors}}
