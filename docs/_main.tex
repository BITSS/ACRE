...
In this stage, you will choose or be assigned a candidate paper to reproduce. You will verify whether or not a reproduction package for your candidate paper exists. We define a \textbf{reproduction package} (sometimes referred to as a ``replication package'') as the collection of all materials that make it possible for a reproducer to reproduce the paper. This package may contain data, code, and/or documentation.
...
\hypertarget{select-a-candidate-paper-or-be-assigned-one-several-weeks-before-starting-the-exercise.}{%
\subsection{Select a candidate paper or be assigned one (several weeks before starting the exercise).}\label{select-a-candidate-paper-or-be-assigned-one-several-weeks-before-starting-the-exercise.}}
...
\tightlist
\item
  Verify the existence of a previous entry on ACRE (under construction) on your candidate paper.\\
\item
  Check the paper's webpage in the official journal or publishers website. Look for links similar to ``Data and Materials'', ``Supplemental Materials'', ``Reproduction/Replication Package/Materials''.\\
\item
  Look for links in the paper (review footnotes and appendices).\\
\item
  Review the personal websites of all the authors in the paper.
\end{enumerate}
...
\textbf{We strongly encourage you to contact authors several weeks before officially starting the main parts of Scoping stage of this exercise. Instructors should also plan to use the ACRE exercise accordingly (eg. if the reproduction is expected to take place in the middle of the semester, students should plan on contacting the authors of a missing reproduction package on the first few weeks of the semester.}

\hypertarget{verify-existence-of-reproduction-package-for-candidate-paper}{%
\subsection{Verify existence of reproduction package for candidate paper}\label{verify-existence-of-reproduction-package-for-candidate-paper}}

At this point you are \emph{only validating the existence} of (at least) one reproduction package and not assessing the quality of its content.
...
\hypertarget{decision-tree-to-move-from-candidate-to-declared-paper}{%
\subsection{Decision Tree to Move From Candidate to Declared Paper}\label{decision-tree-to-move-from-candidate-to-declared-paper}}
...
View Decision Tree To Select Paper (Emma: add title)
...
Go through this decision trees until you have found a paper with a reproduction package -- this will be your \textbf{\emph{declared paper}} and you will try to reproduce it for the remainder of the ACRE exercise. Do not invest time in doing a detailed read of any paper until you are sure that it is your declared paper.

\hypertarget{a-final-note-on-contacting-the-authors}{%
\subsubsection{A final note on contacting the authors}\label{a-final-note-on-contacting-the-authors}}

Before contacting the authors, we recommend that you review and use language from \href{https://bitss.github.io/ACRE/guidance-for-a-constructive-exchange-between-reproducers-and-original-authors.html}{Chapter 6: Communications guidance} below, in this section we have drafter a template email for this specific scenario {[}ALEKS inciter link to email here{]} (contacting the authors for obtain access to gain access to a reproduction package for the first time). If the authors provide any materials, deposit them in a trusted repository (for example \href{https://osf.io/}{Open Science Framework}, \href{https://www.openicpsr.org/openicpsr/}{Open ICPSR}, or \href{https://dataverse.org/}{Dataverse}) and deposit all these materials under the name \texttt{Original\ reproduction\ package\ for\ -\ Title\ of\ the\ paper}. Provide the URL of the repository in Survey 1. If you fail to obtain the reproduction package and would like to choose a different paper, please record this in the ``candidate paper'' section of Survey 1.
...
\addcontentsline{toc}{subsubsection}{Declare possible robustness checks to main estimates (optional).}
...
\section*{Bonus: Identify your relevant timeline.}\label{bonus-identify-your-relevant-timeline.}}
\addcontentsline{toc}{section}{Bonus: Identify your relevant timeline.}
...
\hline
"Current Population Survey 2018" & A1 & cepr\_march\_2018.dta &  & \textbackslash{}data\textbackslash{}\\
\hline
"DHS 2010 - 2013" & 4 & nicaraguaDHS\_2010.csv; boliviaDHS2010.csv; nicaraguaDHS\_2011.csv; nicaraguaDHS\_2012.csv; boliviaDHS\_2012.csv; nicaraguaDHS\_2013.csv; boliviaDHS\_2013.csv & boliviaDHS\_2011.csv & \textbackslash{}rawdata\textbackslash{}DHS\textbackslash{}\\
\hline
"2017 SAT scores" & 4 & Not available &  & \textbackslash{}data\textbackslash{}to\_clean\textbackslash{}\\
\hline
... & ... & ... & ... & ...\\
\hline
\end{tabular}
...
This simplified tree gives you a list of potential files where you could test different \textbf{reasonable specifications}. Here we use (\href{https://urisohn.com/sohn_files/wp/wordpress/wp-content/uploads/Paper-Specification-curve-2018-11-02.pdf}{CITE SIMONS}) definition of reasonable specification which consists on a set of ``(1) sensible tests of the research question, (2) expected to be statistically valid, and (3) not redundant with other specifications in the set''. When performing the different robustness tests, you will be asked to record the relevant section of the code that will be modified, and provide a brief justication of its validity and sensibility.
