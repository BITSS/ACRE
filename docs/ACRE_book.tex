...
\makeatother
\subtitle{\href{https://www.bitss.org/}{\includegraphics{images/BITSS_logo_horizontal.png}}}
\author{ACRE Team}
\date{2021-07-29}
...
\begin{figure}
\includegraphics[width=0.5\linewidth]{images/robustness_lvl1} \includegraphics[width=0.5\linewidth]{images/robustness_lvl2_4} \includegraphics[width=0.5\linewidth]{images/robustness_lvl5-9} \includegraphics[width=0.5\linewidth]{images/robustness_lvl10} \caption{Universe of robustness tests and its elements}\label{fig:robusts}
\end{figure}
